...
const BASE_TIER_ONE_Y = 411;
const BASE_PLATFORM_LEVEL_STEP = 93.75;
...
const tierY = (tier: number): number =>
  scaleYFromFloor(BASE_TIER_ONE_Y - (tier - 1) * BASE_PLATFORM_LEVEL_STEP);

export const PLATFORM_LAYOUT = [
  { x: scaleX(247.5), y: tierY(1), width: 240 * ARENA_CONTENT_SCALE, tier: 1 },
  { x: scaleX(712.5), y: tierY(1), width: 240 * ARENA_CONTENT_SCALE, tier: 1 },
  { x: scaleX(270), y: tierY(2), width: 160 * ARENA_CONTENT_SCALE, tier: 2 },
  { x: scaleX(690), y: tierY(2), width: 160 * ARENA_CONTENT_SCALE, tier: 2 },
  { x: scaleX(250), y: tierY(3), width: 160 * ARENA_CONTENT_SCALE, tier: 3 },
  { x: scaleX(710), y: tierY(3), width: 160 * ARENA_CONTENT_SCALE, tier: 3 },
  { x: scaleX(270), y: tierY(4), width: 160 * ARENA_CONTENT_SCALE, tier: 4 },
  { x: scaleX(690), y: tierY(4), width: 160 * ARENA_CONTENT_SCALE, tier: 4 },
] as const;
